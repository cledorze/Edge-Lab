...
if [[ "${OS}" = "ubuntu" ]]; then
  ...
  # sudo zypper -n update  # Skipped to avoid full system upgrade
  sudo zypper -n install --auto-agree-with-licenses python313 python313-pip jq curl wget pkgconf bash-completion ansible
